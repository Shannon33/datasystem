...
public class manacard extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					String s1 = "20150001";
					manacard frame = new manacard(s1);
...
//==============================大框架==============
		...
		JButton button_3 = new JButton("\u4FE1\u606F\u7BA1\u7406");
		...
		JButton button4 = new JButton("\u6D3B\u52A8\u7BA1\u7406");
...
//==========member信息表格==================
		...
		model.setColumnIdentifiers(new Object[]{"学号","姓名","电话","班级","部门"});
		member b=new member();
		ResultSet rr = b.All();
...
//		}
		...
		while(j<count)
		{
			...
			String dep = (String)map.get("Dno");
					
		//把以上数据添加到表格模型的一行中
	
						
			model.addRow(new Object[]{xuehao,name,telephone,banji,dep,j+1});
			j++;
		}
//=========================表格结束
//将以上表格部分添加到下面信息查询部分
...
//查询单个成员信息
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(getsno.getText().equals("")||getsno.getText().equals(null))
				{
					JOptionPane.showMessageDialog(null, "查询学号不能为空");
				}
				else 
				{
					infor search=new infor(getsno.getText());
		...
		addmember.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//添加成员=====注册
				register boy = new register();
				boy.setVisible(true);
			}
		});
		addmember.setBounds(531, 440, 123, 29);
		TV4_information.add(addmember);
...
//=================活动查询部分===============
		...
		activity_search.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
					acit_infor search=new acit_infor(getAid.getText());
					search.setVisible(true);
				}
			}
		});
		...
		JButton addactivty = new JButton("\u6DFB\u52A0");
		addactivty.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				add_activity activity1 = new add_activity();
				activity1.setVisible(true);
			}
		});
		addactivty.setBounds(552, 365, 90, 31);
		TV3.add(addactivty);
...
//修改部门按键		
		...
		edit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				depart_infor depart = new depart_infor();
